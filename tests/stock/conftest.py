"""Stock test fixtures: installs base+web+product+stock once per session (mirrors tests/hr/)."""
...
def modules_installed(db_url):
    """Install base+web+product+stock once per session in a dedicated event loop."""
    import asyncio
