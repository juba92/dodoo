"""Fleet test fixtures: installs base+web+hr+fleet once per session (mirrors tests/accounting/)."""
...
def modules_installed(db_url):
    """Install base+web+hr+fleet once per session in a dedicated event loop."""
    import asyncio
